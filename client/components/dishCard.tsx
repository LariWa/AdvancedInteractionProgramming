...
import { Stack, IconButton, Flex, Text, Button, HStack  } from "@react-native-material/core"; 
...
export default function DishCard(props: any) {
    ...
    <HStack  spacing={0} style={styles.dishcard}>
        ...
        <View style={styles.dishcard_details}>
            <Text style={styles.dishcard_details_header}>Title</Text>
            <Text style={styles.dishcard_details_description}>Quisque dictum sapien ut commodo maximus.</Text>
        </View>
    </HStack>
  )
}
